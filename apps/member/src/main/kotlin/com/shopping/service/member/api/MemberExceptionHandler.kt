...
import com.shopping.service.member.service.InactiveMemberException
import com.shopping.service.member.service.InvalidCredentialsException
...
class MemberExceptionHandler {
    ...
    fun handleDuplicateEmail(e: DuplicateEmailException) = error(HttpStatus.CONFLICT, "DUPLICATE_EMAIL", e.message)
    ...
    fun handleInactive(e: InactiveMemberException) = error(HttpStatus.FORBIDDEN, "INACTIVE_MEMBER", e.message)

    @ExceptionHandler(MemberNotFoundException::class)
    fun handleNotFound(e: MemberNotFoundException) = error(HttpStatus.NOT_FOUND, "MEMBER_NOT_FOUND", e.message)
